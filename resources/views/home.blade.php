...
<div class="bg-gray-900 px-20 py-16 rounded-lg mb-8 relative overflow-hidden">
    <span class="texrt-xs uppercase text-gray-700 bg-gray-400 rounded-full px-2 py-1">Programación</span>
    ...
    <img src="{{Vite::asset('resources/images/dev.png')}}" class="absolute right-20 -bottom-20 opacity-20">
</div>
    ...
    <div class="grid grid-cols-1 gap-4 mb-4">
        ...
        <a href="{{ route('post',$post->slug)}}" class="bg-gray-100 rounded-lg px-6 py-4">
            <p class="text-xs flex items-center gap-2">
                <span class="uppercase text-gray-700 bg-gray-200 reounded-full px-2 py-1 ">Tutorial</span>
                <span>{{$post->created_at->format('d/m/Y')}}</span>
            </p>
            <h2 class="text-lg text-gray-900 mt-2">{{$post->title}}</h2>

            <div class="texrt-xs text-gray-900 opacity-75 flex items-center gap-1">
